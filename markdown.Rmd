...
clr <- c("black","gray10","midnightblue","red4","orangered3","darkorange",
          "darkgoldenrod1","darkolivegreen3","forestgreen","darkgreen")
...
p2 <-ggplot(BELdata, value.name=titles,aes(x=variable,y=value, fill=value))+
    ...
    ylim(0,10) +
    coord_flip()+
    scale_fill_gradient2( midpoint=5, low=clr[4], mid=clr[6],high=clr[10]) +
